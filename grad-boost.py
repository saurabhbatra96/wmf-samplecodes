...
for train_index, test_index in skf.split(X, y):
	...
	# Classification
	clf = GradientBoostingClassifier(learning_rate=0.05, min_samples_leaf=0.4, n_estimators=1200, max_features=None, min_samples_split=0.1, max_depth=80)
...
axes.set_title("Gradient Boost GridSearchCV Precision vs Recall")
...
# graph.savefig("plots/gb-gscv.png")
